...
class BloxorzSuite extends FunSuite {
  ...
  test("neighborsWithHistory returning correct values") {
    new Level1 {
  ...
  test("newNeighborsOnly eliminating circles") {
    new Level1 {
      ...
      assert(result.toSet.contains((Block(Pos(2,1),Pos(3,1)), List(Down,Left,Up))))
    }
  }
